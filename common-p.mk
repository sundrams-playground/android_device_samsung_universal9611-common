...
# init
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/configs/init/fstab.exynos9611-p:$(TARGET_COPY_OUT_RAMDISK)/fstab.exynos9611 \
    $(COMMON_PATH)/configs/init/fstab.exynos9611-p:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.exynos9611 \
